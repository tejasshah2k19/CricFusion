						...
						<div
							...
							<div class="d-flex justify-content-center py-4">
								<a href="index.html"
									...
									class="d-none d-lg-block">CricFusion</span>
								</a>
							</div>
							<!-- End Logo -->
									...
									<form class="row g-3 needs-validation" novalidate
										...
										<div class="col-12">
											<label for="yourName" class="form-label">ContactNum</label> <input
												type="text" name="contactNum" class="form-control"
												id="yourName" required>
											<div class="invalid-feedback">Please, enter your
												contact num!</div>
										</div>
										...
										<div class="col-12">
											<label for="yourName" class="form-label">Born Year</label> <input
												type="text" name="bornYear" class="form-control"
												id="yourName" required>
										...
										<div class="col-12">
											<p class="small mb-0">
												Already have an account? <a href="login">Log
													in</a>
											</p>
										</div>
									</form>
